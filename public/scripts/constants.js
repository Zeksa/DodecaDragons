...
const magicUpgradeCosts = [
  2, 3, 8, 12, 30, 100, 300, 1500, 4000, 20000, 100000, 400000, 1e8, 3e8, 1.5e9,
  3e9, 1e11, 4e12, 1e13, 1e16,
];
const darkMagicUpgradeCosts = [
  "e110",
  "e125",
  "e165",
  "e240",
...
const hellLayerEffects = [
  "-<a style='color: #fd0'>Gold</a> gain is severely reduced (log(x)^5)<br>-<a style='color: #bff'>Platinum</a> gain is ^0.1<br>-<a style='color: #60d'>Magifold</a> amount is always 1<br>-<a style='color: #8f8'>Uranium</a> gain is ^0.1",
...
const holyTetrahedronUpgradeCosts = [
  1, 1, 1, 1, 2, 2, 2, 5, 5, 15, 50, 2000, 50000,
];
...
const hypergodNames = [
  "OMNIVERSAL HYPERGOD I:<br>KARUTH",
  "OMNIVERSAL HYPERGOD II:<br>TOMI",
  "OMNIVERSAL HYPERGOD III:<br>DOLKHOR",
  "OMNIVERSAL HYPERGOD IV:<br>BELKIKO",
  "OMNIVERSAL HYPERGOD V:<br>SHOU",
  "OMNIVERSAL HYPERGOD VI:<br>COANGRUATOR",
  "OMNIVERSAL HYPERGOD VII:<br>EXILTIK",
  "OMNIVERSAL HYPERGOD VIII:<br>Tom",
  "OMNIVERSAL HYPERGOD IX:<br>ALUSTRO",
  "OMNIVERSAL HYPERGOD X:<br>IKOR",
  "OMNIVERSAL HYPERGOD XI:<br>WITHLORN",
  "OMNIVERSAL HYPERGOD XII:<br>FINALIKUS",
];
const hypergodDefeatCosts = [
  "ee20000",
  "ee160000",
  "ee400000",
  "ee1e6",
...
const hypergodText = [
  "Your ravenous growth is causing destruction in the omniverse, creature. As the high<br>&#8202;&#8202;ruler of this section of the omniverse, I command you to cease immediately.",
  "&#8202;&#8202;End your mindless chaos and destruction this instant! You have no idea what you're doing to the fabric of reality!",
  "Another greedy soul. You will be disposed of, like all those that came before you.",
  "I wish you would reconsider your actions. ...I suppose it's too late for that now though. The fighting won't stop until either you're gone or all of us are.",
  "Ogghh. You dare wake me from my slumber? This better be important, mortal creature.",
  "&#8202;&#8202;Nuh uh!",
  "You! Can you even begin to fathom the utter destruction you've caused!? The fabric of spacetime is imploding, trillions upon trillions dead under your ignorant foot, and for<br>&#8202;&#8202;what!? I implore you to cease this, organic being!",
  "&#8202;&#8202;Hey mate, not cool, what you're doing. You better back off, bud.",
  "You think you can surpass my power? I will crush you like the insignificant being you<br>&#8202;&#8202;are!",
  "&#8202;&#8202;Bringer of destruction. It is clear I cannot stop you, but I have no choice but to try.<br>&#8202;&#8202;Because there's no telling what will happen to the omniverse if you continue.",
  "You've killed off my bretheren, but the worst is yet to come for you! I'll show you the true power of the hypergods!",
  "&#8202;&#8202;Well, I think that's that. I am the last remaining hypergod. Destroyer of gods, ruler of<br>&#8202;&#8202;everything, the omniverse is now yours and yours alone. Farewell.",
];
...
const nuclearPastaPositiveEffects = [
  "Boost to light/dark essence gain",
  "Boost to death essence gain",
  "Boost to cosmic plague gain",
  "Boost to supercluster effect",
  "Boost to oganesson gain",
];
const nuclearPastaNegativeEffects = [
  "&#8202;&#8202;Zero death essence gain",
  "&#8202;&#8202;Gold amount does not increase",
  "Zero dark/light essence gain",
  "Zero cosmic plague gain",
  "&#8202;&#8202;Gold amount does not increase",
];
...
const achievementNames = [
  ...
  [
    ...
    "Motherlode",
    "BEZOS BEZOS BEZOS",
    "Unending mound of cash",
    "Multiversal",
    "Endless realm of coins",
    "Loaded",
    "Mega-loaded (???)",
    "Sbiisics",
    "On my dime!",
  ...
  [
    "｢Made in Heaven｣",
    "Resets all the way down",
    "Cloudy with a chance of numbers",
    "God rays",
    "Heaven sent",
    "Convex complex",
    "Irreducable",
  ...
  [
    ...
    "No stop signs",
    "Unexplainable",
    "Unidentified floating and spinning object",
    "Octerrific",
  ],
  //Holy fire
  [
    ...
    "Quarks and Gluons",
    "Burn everything",
    "What is it you see in the glow?",
  ],
  //Holy dodecahedrons
  [
    "Hey, it's like the name of the game! :O",
    "Dodecadamned",
    "Dodecadimensional",
    "Dodecalculus",
    "Dodecadeadly",
  ...
  [
    ...
    "Dyson spheres",
    "Dark matter pockets",
    "Non-Euclidean planets",
    "Fat Earth theory",
    "Type IV civilisation",
    "SuperUltraHyperverse",
  ],
  //Omniversal hypergods
  [
    "This is the final achievement row.",
    "You have come an incredibly long way.",
    "Your desire for power is unending.",
    "All who have tried to stop you have failed.",
    "There mustn't be long to go now.",
    "How large really is the omniverse?",
    "You begin to feel the laws of physics break down around you.",
    "What drives you?",
    "What is your final goal? Do you ever intend to stop?",
    "There is only so much of reality to claim.",
...
const achievementRewards = trads.achievementRewards;
const achievementResources = [
  ...
  { name: "cyan sigils", shortName: "C-sigils", internalName: "cyanSigils" },
  {
    name: "blue sigils",
    shortName: "&#8202;&#8202;B-sigils",
    internalName: "blueSigils",
  },
  {
    name: "indigo sigils",
    shortName: "&#8202;&#8202;I-sigils",
    internalName: "indigoSigils",
  },
  {
    name: "violet sigils",
    shortName: "&#8202;&#8202;V-sigils",
    internalName: "violetSigils",
  },
  ...
  },
  {
    name: "total tomes",
    shortName: "&#8202;&#8202;Tomes",
    internalName: "totalTomes",
  },
  {
    name: "blue fire",
    shortName: "&#8202;&#8202;B-fire",
    internalName: "blueFire",
  },
  ...
  { name: "red sigils", shortName: "R-sigils", internalName: "redSigils" },
  {
    name: "orange sigils",
    shortName: "O-sigils",
    internalName: "orangeSigils",
  },
  {
    name: "yellow sigils",
    shortName: "&#8202;&#8202;Y-sigils",
    internalName: "yellowSigils",
  },
  {
    name: "holy tetrahedrons",
    shortName: "Tetra",
    internalName: "holyTetrahedrons",
  },
  {
    name: "holy octahedrons",
    shortName: "Octa",
    internalName: "holyOctahedrons",
  },
  { name: "holy fire", shortName: "H-fire", internalName: "holyFire" },
  {
    name: "holy dodecahedrons",
    shortName: "&#8202;&#8202;Dodeca",
    internalName: "holyDodecahedrons",
  },
  {
    name: "planets",
    shortName: "&#8202;&#8202;Planets",
    internalName: "planets",
  },
  {
    name: "defeated hypergods",
    shortName: "&#8202;&#8202;Omni",
    internalName: "hypergodsDefeated",
  },
];
...
const achievementDisplayUnlocks = [
  ...
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 11, 8, 8, 7, 5, 5, 5, 5, 4, 2,
    1,
  ], //unlock 25 - holy octahedrons
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 9, 9, 7, 7, 6, 6, 6, 6, 4,
    2, 1,
  ], //unlock 26 - holy fire
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 9, 9, 8, 8, 6, 6, 6, 7, 5,
    3, 1,
  ], //unlock 27 - void magic upgrades
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 11, 10, 9, 9, 8, 7, 7, 8, 7,
    4, 5, 1,
  ], //unlock 28 - holy dodecahedrons
  [
  ...
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 11, 11, 11,
    11, 11, 10, 11, 5, 1,
  ], //unlock 30 - Omniversal hypergods
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
    12, 12, 12, 12, 7, 3,
  ], //unlock 31 - Cosmic plague
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
    12, 12, 12, 12, 8, 4,
  ], //unlock 32 - Oganesson
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
    12, 12, 12, 12, 9, 5,
  ], //unlock 33 - Light and dark essences
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
    12, 12, 12, 12, 10, 6,
  ], //unlock 34 - Death essence
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
    12, 12, 12, 12, 12, 8,
  ], //unlock 35 - Nuclear pasta
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
    12, 12, 12, 12, 12, 10,
  ], //unlock 36 - Finality essence
  [
    12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12,
    12, 12, 12, 12, 12, 12,
  ], //unlock 37 - Finality cubes
];
